    ...
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <SettingsLayout>
            <div class="flex flex-col space-y-6">
                <HeadingSmall :title="t('profile.infoTitle')" :description="t('profile.infoDescription')" />
                ...
                <Form v-bind="ProfileController.update.form()" class="space-y-6" v-slot="{ errors, processing, recentlySuccessful }">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        >
                            <p v-show="recentlySuccessful" class="text-sm text-neutral-600">{{ t('profile.saved') }}</p>
                        </Transition>
                    </div>
                </Form>
            </div>
